...
namespace Prolog
{
    ...
    public enum BI // builtins
    {
        ...
        xmltrace, xml_transform, random, last
    }
        ...
        case BI.license:
          ...
          break;
                ...
                case BI.random:
                    ...
                    int min = t0.To<int>();
                    int max = t1.To<int>();
                    int rResult = rand.Next(min, max);
                    t2.Unify(new DecimalTerm(rResult), varStack);
                    break;

                case BI.last:
                    t0 = term.Arg(0);
                    t1 = term.Arg(1);
                    ListTerm listT = (ListTerm)t0;
                    int lindex = listT.ToList().Count;
                    t1.Unify(listT.ToList()[lindex-1], varStack);
                    break;
